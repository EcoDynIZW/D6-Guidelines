---
title: "Guidelines for Studies in the Department of Ecological Dynamics of the IZW"
date: "`r Sys.setlocale('LC_TIME', 'C'); paste('Last Update:', format(Sys.time(), '%B %e, %Y'))`"
lang: "en"
output: 
## OPTION A: Word Document
  word_document:
    reference_docx: ./src/guidelines-template.docx
...
knitr::include_graphics('./src/d6_white.png')
```
...
(1) *Individual Dynamics* – PI: Sarah Benhaiem
...
Admin: __________________________________
...
knitr::include_graphics('./src/folder_structure_d6_projects.png')
```
